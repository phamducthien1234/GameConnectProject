...
const riotSection =
    document.getElementById("riotSection");

const rankInput =
    document.getElementById("rank");

const rankHelp =
    document.getElementById("rankHelp");

const fetchRiotButton =
    document.getElementById("fetchRiotButton");
...
fetchRiotButton.addEventListener(
    "click",
    fetchRiotProfile
);
